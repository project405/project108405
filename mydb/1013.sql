...
所以就分享在這裡，如果不行還請告知><', 'movie', NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO "public"."articleMessage" VALUES (1, 1, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第一篇文章留言內容 movie', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (2, 1, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第一篇文章留言內容 movie ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (3, 2, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第二篇文章留言內容 movie ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (4, 2, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第二篇文章留言內容 movie', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (5, 3, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第三篇文章留言內容 music', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (6, 3, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第三篇文章留言內容 music ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (7, 4, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第四篇文章留言內容 music ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (8, 4, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第四篇文章留言內容 music', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (9, 5, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第五篇文章留言內容 book ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (10, 5, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第五篇文章留言內容 book', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (11, 6, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第六篇文章留言內容 book ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (12, 6, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第六篇文章留言內容 book', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (13, 7, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第七篇文章留言內容 exhibition ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (14, 7, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第七篇文章留言內容 exhibition', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (15, 8, 'abc123', '2019-11-30 18:00:00', 'abc123 chin 測試第八篇文章留言內容 exhibition ', NULL, NULL, NULL, NULL);
INSERT INTO "public"."articleMessage" VALUES (16, 8, 'abc456', '2019-11-30 18:20:00', 'abc456 wt 測試第八篇文章留言內容 exhibition', NULL, NULL, NULL, NULL);
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."article_copy1";
CREATE TABLE "public"."article_copy1" (
  "artiNum" int4 NOT NULL DEFAULT nextval('"article_artiNum_seq1"'::regclass),
  "memID" varchar(100) COLLATE "pg_catalog"."default",
  "artiDateTime" timestamp(6),
  "artiHead" varchar(100) COLLATE "pg_catalog"."default",
...
;
COMMENT ON COLUMN "public"."article_copy1"."artiClass" IS 'movie , music , book , exhibition';

-- ----------------------------
-- Records of article_copy1
-- ----------------------------
INSERT INTO "public"."article_copy1" VALUES (1, 'abc123', '2019-05-07 09:25:00', '#分享 #有雷【復仇者聯盟4】謝謝鋼鐵人成就蜘蛛人！', '剛好昨天官方說可以開始討論劇情...
就在網路上看到一篇超級讓人淚腺爆發的漫畫😭

不知道發哪個版比較適合...但這邊好多人都在討論復聯4
所以就分享在這裡，如果不行還請告知><', 'movie', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (2, 'abc456', '2019-05-07 10:30:00', '海洋奇緣觀後感＃雷', '海洋奇緣是2016年上映的電影，我卻最近才看完，原本是帶著看一部卡通的愉快心情，沒想到劇情那麼感人，讓我大爆哭！也可能是那時候我剛考完準備很久的考試，加上對未來有一種迷茫感吧～

總之我覺得這部電影很適合不確定自己要幹嘛、沒自信的人看！', 'movie', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (3, 'abc123', '2019-05-07 19:25:00', '想找一首英文歌', '一開始去是鋼琴 登等登等登*4
然後副歌歌詞聽起來像you are my story
感覺像一個樂團 男生唱的', 'music', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (4, 'abc456', '2019-05-08 12:21:00', '#詢問 尋找好聽的日文歌曲', 'true跟茅原實里的是因為看了某部動畫入坑的
不過聽了一些true的其他歌後
有點不太喜歡…?', 'music', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (5, 'abc123', '2018-01-01 11:20:00', '（書單）2019年起截止到5月7日讀到的好書', '基本都是純文學小說，少人文社科綜合和詩集，祝閱讀愉快( ´ ▽ ` )ﾉ
《大瑟爾》凱魯亞克
《天才的編輯》A·司各特·伯格
《崩潰》菲茨傑羅
《語言與沈默》喬治·斯坦納', 'book', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (6, 'abc456', '2018-03-04 12:11:00', '求推薦 請問有人看過“變身在漫威世界”嗎？', '如題
請問有人有看過“變身在漫威世界”嗎？
本人看了8年小說
至從看了變身在漫威世界之後
感覺其他小說怎麼看怎麼不對', 'book', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (7, 'abc123', '2019-03-04 12:12:00', '後大人時代的我們 免費講座', '從前從前，大人們總是說：「等你長大就懂了。」
如今我們長大了，那些以後就會懂的事，我們真的都懂了嗎？
我們現在都活在曾經相信過的價值觀正被拆解重建著的時代。
女權意識抬頭、同性議題的討論、AI取代人工等等。', 'exhibition', NULL, NULL, NULL, NULL);
INSERT INTO "public"."article_copy1" VALUES (8, 'abc456', '2019-01-01 01:01:00', '學校校慶展覽....', '學校校慶展覽活動到底是要辦給誰看呀？
展覽時間在上課期間😂😂
展覽結束5:00(剛好下課時間)
然後園遊會時間晚上5:00開始到7:00
我真的覺得這個時間點很奇怪
...
-- ----------------------------
INSERT INTO "public"."recommend" VALUES (1, '2018-01-01 23:10:00', '名偵探皮卡丘', '名偵探皮卡丘》是第一部真人寶可夢冒險電影，由萊恩雷諾斯聲演名偵探皮卡丘，改編自廣受喜愛的寶可夢品牌。皮卡丘是轟動全球的寶可夢招牌人物，而寶可夢是全世界最受歡迎又老少咸宜的娛樂商品之一，且是史上最成功的媒體系列之一。    現在，全世界的粉絲能史無前例第一次在大銀幕上看到皮卡丘，這個獨一無二的寶可夢人物這次將化身為名偵 ... ', 'movie', 1, NULL, NULL, NULL);
INSERT INTO "public"."recommend" VALUES (2, '2018-01-02 12:10:00', '詐騙女神', '敘述瑞貝爾威爾森和安海瑟薇是一對擦出精彩火花的女騙徒，她們在位於南法的一座濱海小鎮展開一場騙術大比拼。喬瑟芬柴斯特菲德（安海瑟薇 飾）是一個穿著光鮮亮麗、蠱惑誘人、善於算計、刁滑奸詐的英國正妹，她在濱海博蒙這座位於南法蔚藍海岸的小鎮擁有一棟豪宅，專門詐騙來自世界各地的有錢凱子。潘妮賴斯特（瑞貝爾威爾森 飾）則是一個無憂  ', 'movie', 2, NULL, NULL, NULL);
...
麥田捕手
授權 YouTube 的內容擁有者：
Bin Music (代表Bin Music); ASCAP, The Royalty Network (Publishing), CMRRA與 7 個音樂版權協會', 'music', 1, NULL, NULL, NULL);
...
全票：280元 優待票 （學生、65歲以上長者）:250元 優待票 （持身心障礙手冊者）：140元 團體票 （15人以上、美術相關科系學生）：220元 6歲（含）以下兒童（需憑證）免費入館', 'exhibition', 1, NULL, NULL, NULL);
...
免費入場參觀', 'exhibition', 2, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO "public"."recommendMessage" VALUES (1, 1, 'abc123', '2019-02-02 10:00:00', '阿欽說第一篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (2, 1, 'abc456', '2019-02-02 10:00:00', '違停說第一篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (3, 2, 'abc123', '2019-02-02 10:00:00', '阿欽說第二篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (4, 2, 'abc456', '2019-02-02 10:00:00', '違停說第二篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (5, 3, 'abc123', '2019-02-02 10:00:00', '阿欽說第三篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (6, 3, 'abc456', '2019-02-02 10:00:00', '違停說第三篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (7, 4, 'abc123', '2019-02-02 10:00:00', '阿欽說第四篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (8, 4, 'abc456', '2019-02-02 10:00:00', '違停說第四篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (9, 5, 'abc123', '2019-02-02 10:00:00', '阿欽說第五篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (10, 5, 'abc456', '2019-02-02 10:00:00', '違停說第五篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (11, 6, 'abc123', '2019-02-02 10:00:00', '阿欽說第六篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (12, 6, 'abc456', '2019-02-02 10:00:00', '違停說第六篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (13, 7, 'abc123', '2019-02-02 10:00:00', '阿欽說第七篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (14, 7, 'abc456', '2019-02-02 10:00:00', '違停說第七篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (15, 8, 'abc123', '2019-02-02 10:00:00', '阿欽說第八篇推薦文章好讚喔好好看這是內容', NULL, NULL, NULL, NULL);
INSERT INTO "public"."recommendMessage" VALUES (16, 8, 'abc456', '2019-02-02 10:00:00', '違停說第八篇推薦文章太帥了ㄅ這是內容', NULL, NULL, NULL, NULL);
...
-- ----------------------------
SELECT setval('"public"."articleLike_artiLikeNum_seq"', 9, false);
...
SELECT setval('"public"."articleMessageLike_artiMessLikeNum_seq"', 9, false);
...
SELECT setval('"public"."articleMessage_artiMessNum_seq"', 9, false);
...
SELECT setval('"public"."article_artiNum_seq"', 9, false);
...
SELECT setval('"public"."bookStyleSet_bookStyleSetNum_seq"', 9, false);
...
SELECT setval('"public"."bookStyle_bookStyleNum_seq"', 9, false);
...
SELECT setval('"public"."exhibitionStyle_exhStyleNum_seq"', 9, false);
...
SELECT setval('"public"."exhibition_exhNum_seq"', 9, false);
...
SELECT setval('"public"."memberCollection_collNum_seq"', 9, false);
...
SELECT setval('"public"."movieStyleSet_movStyleSetNum_seq"', 9, false);
...
SELECT setval('"public"."movieStyle_movStyleNum_seq"', 9, false);
...
SELECT setval('"public"."musicStyle_musStyleNum_seq"', 9, false);
...
SELECT setval('"public"."music_musNum_seq"', 9, false);
ALTER SEQUENCE "public"."music_musNum_seq1"
OWNED BY "public"."music"."musNum";
SELECT setval('"public"."music_musNum_seq1"', 3, true);
SELECT setval('"public"."orddetails_serno_seq"', 3007, false);
SELECT setval('"public"."prefer_preferNum_seq"', 9, false);
...
SELECT setval('"public"."recommendClass_recomClassNum_seq"', 9, false);
SELECT setval('"public"."recommendLike_recomLikeNum_seq"', 9, false);
...
SELECT setval('"public"."recommendMessageLike_recomMessLikeNum_seq"', 9, false);
...
SELECT setval('"public"."recommendMessage_recomMessNum_seq"', 9, false);
...
SELECT setval('"public"."recommend_recomNum_seq"', 9, false);
...
SELECT setval('"public"."report_reportNum_seq"', 9, false);
...
SELECT setval('"public"."tagLinkArticle_tagLinkArtiNum_seq"', 9, false);
...
SELECT setval('"public"."tag_tagNum_seq"', 9, false);
...
-- ----------------------------
-- Primary Key structure for table article_copy1
-- ----------------------------
ALTER TABLE "public"."article_copy1" ADD CONSTRAINT "article_copy1_pkey" PRIMARY KEY ("artiNum");
...
-- ----------------------------
-- Foreign Keys structure for table article_copy1
-- ----------------------------
ALTER TABLE "public"."article_copy1" ADD CONSTRAINT "article_copy1_memID_fkey" FOREIGN KEY ("memID") REFERENCES "public"."member" ("memID") ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE "public"."image" ADD CONSTRAINT "image_recomNum_fkey" FOREIGN KEY ("recomNum") REFERENCES "public"."recommend" ("recomNum") ON DELETE CASCADE ON UPDATE RESTRICT;
