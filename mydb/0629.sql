...
-- Records of member
-- ----------------------------
INSERT INTO "public"."member" VALUES ('abc123', 'abc123', '1997-09-28', 'chin', '10546007@ntub.edu.tw', 'm', 't', '深坑');
INSERT INTO "public"."member" VALUES ('abc456', 'abc456', '1998-08-07', 'wat', '10546004@ntub.edu.tw', 'f', 'f', '三重');
...
-- ----------------------------
INSERT INTO "public"."recommend" VALUES (1, '2018-01-01 23:10:00', '名偵探皮卡丘', '名偵探皮卡丘》是第一部真人寶可夢冒險電影，由萊恩雷諾斯聲演名偵探皮卡丘，改編自廣受喜愛的寶可夢品牌。皮卡丘是轟動全球的寶可夢招牌人物，而寶可夢是全世界最受歡迎又老少咸宜的娛樂商品之一，且是史上最成功的媒體系列之一。    現在，全世界的粉絲能史無前例第一次在大銀幕上看到皮卡丘，這個獨一無二的寶可夢人物這次將化身為名偵 ... ', 'movie', 1, NULL);
INSERT INTO "public"."recommend" VALUES (2, '2018-01-02 12:10:00', '詐騙女神', '敘述瑞貝爾威爾森和安海瑟薇是一對擦出精彩火花的女騙徒，她們在位於南法的一座濱海小鎮展開一場騙術大比拼。喬瑟芬柴斯特菲德（安海瑟薇 飾）是一個穿著光鮮亮麗、蠱惑誘人、善於算計、刁滑奸詐的英國正妹，她在濱海博蒙這座位於南法蔚藍海岸的小鎮擁有一棟豪宅，專門詐騙來自世界各地的有錢凱子。潘妮賴斯特（瑞貝爾威爾森 飾）則是一個無憂  ', 'movie', 2, NULL);
...
麥田捕手
授權 YouTube 的內容擁有者：
Bin Music (代表Bin Music); ASCAP, The Royalty Network (Publishing), CMRRA與 7 個音樂版權協會', 'music', 1, NULL);
...
全票：280元 優待票 （學生、65歲以上長者）:250元 優待票 （持身心障礙手冊者）：140元 團體票 （15人以上、美術相關科系學生）：220元 6歲（含）以下兒童（需憑證）免費入館', 'exhibition', 1, NULL);
...
-- Records of report
-- ----------------------------
INSERT INTO "public"."report" VALUES (1, 1, NULL, NULL, '太色情了吧', '2019-06-29 06:45:00');
INSERT INTO "public"."report" VALUES (2, 2, NULL, NULL, '不知道在說啥', '2019-06-29 06:45:00');
INSERT INTO "public"."report" VALUES (3, NULL, 1, NULL, '亂打一通', '2019-06-29 06:45:00');
INSERT INTO "public"."report" VALUES (4, NULL, 2, NULL, '欠檢舉', '2019-06-29 06:45:00');
INSERT INTO "public"."report" VALUES (5, NULL, NULL, 1, '就想檢舉阿', '2019-06-29 06:45:00');
INSERT INTO "public"."report" VALUES (6, NULL, NULL, 2, '封鎖他!!!', '2019-06-29 06:45:00');
...
-- ----------------------------
SELECT setval('"public"."articleLike_artiLikeNum_seq"', 4, false);
...
SELECT setval('"public"."articleMessageLike_artiMessLikeNum_seq"', 4, false);
...
SELECT setval('"public"."articleMessage_artiMessNum_seq"', 4, false);
...
SELECT setval('"public"."article_artiNum_seq"', 4, false);
...
SELECT setval('"public"."bookStyleSet_bookStyleSetNum_seq"', 4, false);
...
SELECT setval('"public"."bookStyle_bookStyleNum_seq"', 4, false);
...
SELECT setval('"public"."exhibitionStyle_exhStyleNum_seq"', 4, false);
...
SELECT setval('"public"."exhibition_exhNum_seq"', 4, false);
...
SELECT setval('"public"."memberCollection_collNum_seq"', 4, false);
...
SELECT setval('"public"."movieStyleSet_movStyleSetNum_seq"', 4, false);
...
SELECT setval('"public"."movieStyle_movStyleNum_seq"', 4, false);
...
SELECT setval('"public"."musicStyle_musStyleNum_seq"', 4, false);
...
SELECT setval('"public"."music_musNum_seq"', 4, false);
ALTER SEQUENCE "public"."music_musNum_seq1"
OWNED BY "public"."music"."musNum";
SELECT setval('"public"."music_musNum_seq1"', 3, true);
SELECT setval('"public"."orddetails_serno_seq"', 3002, false);
SELECT setval('"public"."prefer_preferNum_seq"', 4, false);
...
SELECT setval('"public"."recommendClass_recomClassNum_seq"', 4, false);
SELECT setval('"public"."recommendLike_recomLikeNum_seq"', 4, false);
...
SELECT setval('"public"."recommendMessageLike_recomMessLikeNum_seq"', 4, false);
...
SELECT setval('"public"."recommendMessage_recomMessNum_seq"', 4, false);
...
SELECT setval('"public"."recommend_recomNum_seq"', 4, false);
...
SELECT setval('"public"."report_reportNum_seq"', 4, false);
...
SELECT setval('"public"."tagLinkArticle_tagLinkArtiNum_seq"', 4, false);
...
SELECT setval('"public"."tag_tagNum_seq"', 4, false);
