...
-- ------------------------------
INSERT INTO "recommend" ("recomDateTime","recomHead","recomCont","recomClass") VALUES
('2018-01-01 23:10:00','名偵探皮卡丘','名偵探皮卡丘》是第一部真人寶可夢冒險電影，由萊恩雷諾斯聲演名偵探皮卡丘，改編自廣受喜愛的寶可夢品牌。皮卡丘是轟動全球的寶可夢招牌人物，而寶可夢是全世界最受歡迎又老少咸宜的娛樂商品之一，且是史上最成功的媒體系列之一。    現在，全世界的粉絲能史無前例第一次在大銀幕上看到皮卡丘，這個獨一無二的寶可夢人物這次將化身為名偵 ... ','movie'),
('2018-01-02 12:10:00','詐騙女神','敘述瑞貝爾威爾森和安海瑟薇是一對擦出精彩火花的女騙徒，她們在位於南法的一座濱海小鎮展開一場騙術大比拼。喬瑟芬柴斯特菲德（安海瑟薇 飾）是一個穿著光鮮亮麗、蠱惑誘人、善於算計、刁滑奸詐的英國正妹，她在濱海博蒙這座位於南法蔚藍海岸的小鎮擁有一棟豪宅，專門詐騙來自世界各地的有錢凱子。潘妮賴斯特（瑞貝爾威爾森 飾）則是一個無憂  ','movie'),
...
麥田捕手
授權 YouTube 的內容擁有者：
Bin Music (代表Bin Music); ASCAP, The Royalty Network (Publishing), CMRRA與 7 個音樂版權協會','music'),
...
稍息立正我愛你原聲帶
授權 YouTube 的內容擁有者：
HIMservice (代表HIM International Music Inc.); UMPI與 3 個音樂版權協會','music'),
...
全票：280元 優待票 （學生、65歲以上長者）:250元 優待票 （持身心障礙手冊者）：140元 團體票 （15人以上、美術相關科系學生）：220元 6歲（含）以下兒童（需憑證）免費入館','exhibition'),
