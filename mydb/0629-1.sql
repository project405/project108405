...
-- ----------------------------
SELECT setval('"public"."articleLike_artiLikeNum_seq"', 5, false);
...
SELECT setval('"public"."articleMessageLike_artiMessLikeNum_seq"', 5, false);
...
SELECT setval('"public"."articleMessage_artiMessNum_seq"', 5, false);
...
SELECT setval('"public"."article_artiNum_seq"', 5, false);
...
SELECT setval('"public"."bookStyleSet_bookStyleSetNum_seq"', 5, false);
...
SELECT setval('"public"."bookStyle_bookStyleNum_seq"', 5, false);
...
SELECT setval('"public"."exhibitionStyle_exhStyleNum_seq"', 5, false);
...
SELECT setval('"public"."exhibition_exhNum_seq"', 5, false);
...
SELECT setval('"public"."memberCollection_collNum_seq"', 5, false);
...
SELECT setval('"public"."movieStyleSet_movStyleSetNum_seq"', 5, false);
...
SELECT setval('"public"."movieStyle_movStyleNum_seq"', 5, false);
...
SELECT setval('"public"."musicStyle_musStyleNum_seq"', 5, false);
...
SELECT setval('"public"."music_musNum_seq"', 5, false);
...
SELECT setval('"public"."prefer_preferNum_seq"', 5, false);
...
SELECT setval('"public"."recommendClass_recomClassNum_seq"', 5, false);
SELECT setval('"public"."recommendLike_recomLikeNum_seq"', 5, false);
...
SELECT setval('"public"."recommendMessageLike_recomMessLikeNum_seq"', 5, false);
...
SELECT setval('"public"."recommendMessage_recomMessNum_seq"', 5, false);
...
SELECT setval('"public"."recommend_recomNum_seq"', 5, false);
...
SELECT setval('"public"."report_reportNum_seq"', 5, false);
...
SELECT setval('"public"."tagLinkArticle_tagLinkArtiNum_seq"', 5, false);
...
SELECT setval('"public"."tag_tagNum_seq"', 5, false);
